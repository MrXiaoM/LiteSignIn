...
public class SkullsUtil {
    ...
    public static void init() {
        HAS_PLAYER_PROFILES = isPresent("org.bukkit.profile.PlayerProfile");
    }
    ...
    public static Skull generateSkull(@NotNull String base64) {
        ...
        return new Skull(meta -> {
            ...
            try {
                ...
                Main.getInstance().getLogger().log(Level.WARNING, "无法从 base64 加载头颅材质", e);
            }
        });
    }
    ...
    private static PlayerProfile getPlayerProfile(@NotNull String base64) {
        ...
        try {
            ...
            Main.getInstance().getLogger().log(Level.WARNING, "尝试创建 base64 头颅材质链接时出现问题", e);
        }
